...
const getTimeList = ({ bokkings, selectedDay }: getTimeListProps) => {
  return TIME_LIST.filter((time) => {
    const hour = Number(time.split(":")[0]) // ["09","00"] -> 9
    ...
    const hasBookingOnCurrentTime = bokkings.some(
      (booking) =>
  ...
  const handleCreateBooking = async () => {
    ...
    try {
      ...
      toast.success("Reserva criada com sucesso!", {
        description: `${format(selectedDate, "cccc, dd 'de' MMMM ' as  ' p", { locale: ptBR })}`,
        action: {
            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <SheetContent className="w-[80%] px-0 md:overflow-x-auto">
                  ...
                  <div className="border-b border-solid py-5 md:py-1">
                    <Calendar
                      mode="single"
                      locale={ptBR}
