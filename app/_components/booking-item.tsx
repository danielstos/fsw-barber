    ...
    <>
      <div className="block md:hidden">
        <Sheet open={isSheetOpen} onOpenChange={handleSheetOpenChange}>
          <SheetTrigger
            onClick={onClick}
            className="w-full min-w-[90%] md:min-w-[100%]"
          >
          ...
          <SheetContent className="block w-[85%] md:hidden">
            <SheetHeader>
                    ...
                    <DialogContent className="w-[90%]">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          ...
                          recuperar ? Essa ação é irreversível.
                        </DialogDescription>
                      </DialogHeader>
      ...
      {/* Desktop: Usar o onClick para selecionar o agendamento */}
      <div className="hidden sm:block md:min-w-[100%]" onClick={onClick}>
        <Card className="min-w-[100%] cursor-pointer">
